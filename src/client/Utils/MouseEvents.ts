...
class MouseEvents {
  ...
  constructor(main: SceneInit, { meshes, wrappers }: rt) {
    ...
    this.ogMaterial = meshes.map((mesh) => mesh.material as THREE.MeshBasicMaterial);
  ...
  public highLight(): void {
    this.main.renderer.domElement.addEventListener('mousemove', this.onMouseMove, false);
  }
}
